 ...
 * Modificado por: Nicolás Pueyo Soria
 * Última revisión: 19 de septiembre de 2022
 * Resumen: Tarea 6
 ******************************************************************************/
#include <iostream>
#include <cmath>
...
int main() {
    const int ANCHO = 9;
    cout << setw(ANCHO) << "Grados" << setw(ANCHO) << "Radianes" << setw(ANCHO) << "Seno" 
    << setw(ANCHO) << "Coseno" << endl;

    cout << setw(ANCHO) << "========" << setw(ANCHO) << "========" << setw(ANCHO) << "========" 
    << setw(ANCHO) << "========" << endl;
    ...
    for (double grados = 0; grados <= 180; grados += 10) {
        ...
        cout << setprecision(0) << setw(ANCHO) << grados 
             << setprecision(4) << setw(ANCHO) << radianes 
             << setw(ANCHO) << sin(radianes)
             << setw(ANCHO) << cos(radianes)
             << endl;
    }
    system("pause");
}
